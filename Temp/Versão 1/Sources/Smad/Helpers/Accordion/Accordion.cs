...
namespace Opulos.Core.UI {
    ...
    public class Accordion : UserControl, IMessageFilter {
        ...
        public String MidArrow { get; set; }
        ...
        public CheckBox Add(Control c, String text, String toolTip = null, double fillWt = 0, bool? open = null, Padding? contentPadding = null, Padding? contentMargin = null, Color? contentBackColor = null, Padding? checkboxMargin = null, bool? addResizeBar = null, bool? isMidArrow = null, Padding? resizeBarMargin = null, LayoutArgs layoutArgs = null) {
        ...
        public CheckBox Add(AddArgs args) {
            ...
            bool? isMidArrow = args.isMidArrow;
            ...
            if (isMidArrow == false) {
                ...
                cb.Text = (cb.Checked ? GetMidArrow() : GetMidArrow()) + cb.Text;
            }
            ...
            cb.CheckedChanged += delegate {
                ...
                String midArrow = GetMidArrow();
                String text = cb.Text;
                isAnimating = true;
                if (text.StartsWith(midArrow))
                    text = text.Substring(midArrow.Length);
                ...
                CheckedChanged?.Invoke(c, null);
                CategoryCheckedChanged?.Invoke(cb, null);
            };
        ...
        public event EventHandler CategoryCheckedChanged;
        ...
        private String GetMidArrow() {
            return (this.MidArrow == null ? "" : this.MidArrow);
        }

...
namespace LiveShowStudio.Modules.ObjectListView {
    ...
    public class FilterMenuBuilder {
        ...
        /// </summary>
        static public Bitmap ClearFilteringImage = LiveShowStudio.Modules.ObjectListView.Properties.Resources.ClearFiltering;

        /// <summary>
        /// Gets or sets the image that will be placed next to all "Apply" menu items on the filtering menu
        /// </summary>
        static public Bitmap FilteringImage = LiveShowStudio.Modules.ObjectListView.Properties.Resources.Filtering;
